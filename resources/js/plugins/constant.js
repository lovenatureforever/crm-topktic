...
const rolesByAdmin = [ROLE_LEADER, ROLE_AGENT]
const rolesByTeamLeader = [ROLE_AGENT]
const user_states = [STATUS_ACTIVE, STATUS_INACTIVE]
const filter_user_states = [ALL, STATUS_ACTIVE, STATUS_INACTIVE]
const allRoles = [ALL, ROLE_ADMIN, ROLE_LEADER, ROLE_AGENT]
...
const allStatus = [ALL, ...user_states]
...
const tableHeaders = {
  ...
  campaignTable: [
    ...
    { key: "assigned_user", title: "Assigned Agent" },
    ...
    // {
    //   key: "applicantbusinessregistrationnumber",
    //   title: "Applicant Business Registration Number",
    // },
...
const RACE = ["malay", "chinese", "indian", "other"]
